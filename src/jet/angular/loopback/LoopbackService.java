...
public class LoopbackService
{
  ...
  protected final String TEXT_5 = " } from 'src/app/dados/";
  protected final String TEXT_6 = "';" + NL + "import { of } from 'rxjs';" + NL + "" + NL + "/**" + NL + " * Api services for the `Aplicacao` model." + NL + " */" + NL + "@Injectable()" + NL + "export class ";
  ...
  protected final String TEXT_12 = "[0]);" + NL + "  }" + NL + "}";
