...
public class ListaVitrinePageHtml
{
  protected static String nl;
  public static synchronized ListaVitrinePageHtml create(String lineSeparator)
  {
    nl = lineSeparator;
    ListaVitrinePageHtml result = new ListaVitrinePageHtml();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_2 = NL + NL + "<ion-header>" + NL + "  <ion-navbar color=\"primary\">" + NL + "    <ion-title (click)=\"testaFoto()\">";
