...
public class ListaItemPageBaseTs
{
  ...
  protected final String TEXT_5 = "Base {" + NL + "  protected listaItem: ";
  protected final String TEXT_6 = "[];" + NL + "" + NL + "  constructor(protected navCtrl: NavController, protected srv: ";
  protected final String TEXT_7 = "Api, " + NL + "  \t\t\t\t protected screenshot: Screenshot) {" + NL + "  }" + NL + "" + NL + "  " + NL + "  protected carregaLista() {" + NL + "    this.srv.";
  protected final String TEXT_8 = "()" + NL + "      .subscribe((result: ";
  protected final String TEXT_9 = "[]) => {" + NL + "        console.log('Result', JSON.stringify(result));" + NL + "        this.listaItem = result;" + NL + "      });" + NL + "  }" + NL + "  " + NL + "   " + NL + "  protected carregaListaPrototipo() {" + NL + "    this.srv.";
  protected final String TEXT_10 = "()" + NL + "      .subscribe((result: ";
  protected final String TEXT_11 = "[]) => {" + NL + "        console.log('Result-Prototipo', JSON.stringify(result));" + NL + "        this.listaItem = result;" + NL + "      });" + NL + "  }" + NL + "  " + NL + "  protected testaFoto() {" + NL + "    this.screenshot.save('jpg', 100, '";
