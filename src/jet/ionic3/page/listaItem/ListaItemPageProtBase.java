...
public class ListaItemPageProtBase
{
  protected static String nl;
  public static synchronized ListaItemPageProtBase create(String lineSeparator)
  {
    nl = lineSeparator;
    ListaItemPageProtBase result = new ListaItemPageProtBase();
    nl = null;
    return result;
  }
