...
public class ListaItemPageProdBaseTs
{
  ...
  protected final String TEXT_9 = "[]) => {" + NL + "  \t\t\t\tconsole.log('ListaItem:' , resultado);" + NL + "  \t\t\t\tthis.listaItem = resultado;" + NL + "  \t\t\t})" + NL + "  \t}" + NL + "  " + NL + "\tprotected alterar(item: Exercicio) {" + NL + "\t\tthis.navCtrl.push(this.getPageEdicao(), {" + NL + "      \t\titem: item" + NL + "\t\t});" + NL + "  \t}" + NL + "}";
