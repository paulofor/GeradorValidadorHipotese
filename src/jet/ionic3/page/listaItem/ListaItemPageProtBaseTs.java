...
public class ListaItemPageProtBaseTs
{
  protected static String nl;
  public static synchronized ListaItemPageProtBaseTs create(String lineSeparator)
  {
    nl = lineSeparator;
    ListaItemPageProtBaseTs result = new ListaItemPageProtBaseTs();
    nl = null;
    return result;
  }
