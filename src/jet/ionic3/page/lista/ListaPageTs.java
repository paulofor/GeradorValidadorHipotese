...
public class ListaPageTs
{
  ...
  protected final String TEXT_9 = "Api, public modalCtrl: ModalController) {" + NL + "  }" + NL + "" + NL + "  ionViewWillEnter() {" + NL + "    console.log('ionViewWillEnter ";
  ...
  protected final String TEXT_12 = "[]) => {" + NL + "        console.log('Result', JSON.stringify(result));" + NL + "        this.listaItem = result;" + NL + "      });" + NL + "  }" + NL + "" + NL + "  " + NL + "}";
