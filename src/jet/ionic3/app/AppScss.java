...
public class AppScss
{
  ...
  protected final String TEXT_4 = NL + "}" + NL + "" + NL + "" + NL + ".linha1 {" + NL + "    padding-top: 5px" + NL + "}" + NL + ".linhan {" + NL + "    padding-top: 2px; " + NL + "}" + NL + "" + NL + "" + NL + ".quadro10 {" + NL + "    height: 10%;" + NL + "}" + NL + ".quadro20 {" + NL + "    height: 20%;" + NL + "}" + NL + ".quadro30 {" + NL + "    height: 30%;" + NL + "}" + NL + ".quadro40 {" + NL + "    height: 40%;" + NL + "}" + NL + ".quadro50 {" + NL + "    height: 50%;" + NL + "}" + NL + ".quadro60 {" + NL + "    height: 60%;" + NL + "}" + NL + ".quadro70 {" + NL + "    height: 70%;" + NL + "}" + NL + ".quadro80 {" + NL + "    height: 80%;" + NL + "}" + NL + ".quadro90 {" + NL + "    height: 90%;" + NL + "}" + NL + "" + NL + "" + NL + ".botaoPrincipal {" + NL + "    width: 80%;" + NL + "    margin: 0 auto;" + NL + "    display: block;" + NL + "}";
