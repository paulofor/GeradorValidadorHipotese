...
public class AppModuleTs
{
  ...
  protected final String TEXT_10 = NL + NL + NL + "@NgModule({" + NL + "  declarations: [" + NL + "    MyApp," + NL + "    HomePage," + NL + "    LoginPage," + NL + "    SignupPage," + NL + "    ComandosZeroPage,";
  protected final String TEXT_11 = NL + "    ";
  protected final String TEXT_12 = "," + NL + "\t";
  protected final String TEXT_13 = NL + "  ]," + NL + "  imports: [" + NL + "    BrowserModule," + NL + "    IonicModule.forRoot(MyApp)," + NL + "    HttpClientModule," + NL + "    SDKBrowserModule.forRoot()," + NL + "    ChartsModule," + NL + "    IonicStorageModule.forRoot()," + NL + "    BrMaskerModule" + NL + "  ]," + NL + "  bootstrap: [IonicApp]," + NL + "  entryComponents: [" + NL + "    MyApp," + NL + "    HomePage," + NL + "    LoginPage," + NL + "    SignupPage," + NL + "    ComandosZeroPage,";
