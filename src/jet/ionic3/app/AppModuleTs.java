...
public class AppModuleTs
{
  ...
  protected final String TEXT_13 = NL + "  ]," + NL + "  imports: [" + NL + "    BrowserModule," + NL + "    IonicModule.forRoot(MyApp)," + NL + "    HttpClientModule," + NL + "    SDKBrowserModule.forRoot()," + NL + "    ChartsModule," + NL + "    IonicStorageModule.forRoot()" + NL + "  ]," + NL + "  bootstrap: [IonicApp]," + NL + "  entryComponents: [" + NL + "    MyApp," + NL + "    HomePage," + NL + "    LoginPage," + NL + "    SignupPage,";
