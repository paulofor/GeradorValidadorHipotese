...
public class AppComponentTs
{
  protected static String nl;
  public static synchronized AppComponentTs create(String lineSeparator)
  {
    nl = lineSeparator;
    AppComponentTs result = new AppComponentTs();
    nl = null;
    return result;
  }
